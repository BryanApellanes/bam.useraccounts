...
namespace Bam.Net.UserAccounts.Data
{
	...
	public GroupPermissionCollection GroupPermissionsByGroupId
	{
		...
		/// </param>
		[Bam.Net.Exclude]
		public static GroupCollection Top(int count, WhereDelegate<GroupColumns> where, OrderBy<GroupColumns> orderBy, IDatabase database = null)
		{
			GroupColumns c = new GroupColumns();
			IQueryFilter filter = where(c);         
			
			IDatabase db = database ?? Db.For<Group>();
		...
		/// </param>
		[Bam.Net.Exclude]
		public static GroupCollection Top(int count, QueryFilter where, OrderBy<GroupColumns> orderBy = null, IDatabase database = null)
		{
			IDatabase db = database ?? Db.For<Group>();
			IQuerySet query = GetQuerySet(db);
			query.Top<Group>(count);
		...
		[Bam.Net.Exclude]
		public static GroupCollection Top(int count, QueryFilter where, string orderBy = null, SortOrder sortOrder = SortOrder.Ascending, IDatabase database = null)
		{
			IDatabase db = database ?? Db.For<Group>();
			IQuerySet query = GetQuerySet(db);
			query.Top<Group>(count);
		...
		/// Which database to query or null to use the default
		/// </param>
		public static GroupCollection Top(int count, QiQuery where, IDatabase database = null)
		{
			IDatabase db = database ?? Db.For<Group>();
			IQuerySet query = GetQuerySet(db);
			query.Top<Group>(count);
		...
		/// </param>
		[Bam.Net.Exclude]
		public static long Count(WhereDelegate<GroupColumns> where, IDatabase database = null)
		{
			GroupColumns c = new GroupColumns();
			IQueryFilter filter = where(c) ;
