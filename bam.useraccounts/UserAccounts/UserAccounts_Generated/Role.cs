...
namespace Bam.Net.UserAccounts.Data
{
	...
	public UserRoleCollection UserRolesByRoleId
	{
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static Role OneWhere(WhereDelegate<RoleColumns> where, IDatabase database = null)
		{
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static RoleCollection Top(int count, WhereDelegate<RoleColumns> where, IDatabase database = null)
		{
