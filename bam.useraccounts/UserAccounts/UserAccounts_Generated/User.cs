...
namespace Bam.Net.UserAccounts.Data
{
    ...
    public partial class User : Bam.Net.Data.Dao, IUser
    {
        public User() : base()
        {
        ...
        /// <param name="database"></param>
        [Bam.Net.Exclude]
        public static User OneWhere(QueryFilter where, IDatabase database = null)
        {
        ...
        /// <param name="database"></param>
        [Bam.Net.Exclude]
        public static User GetOneWhere(WhereDelegate<UserColumns> where, IDatabase database = null)
        {
            var result = OneWhere(where, database);
            if (result == null)
            {
        ...
        /// <param name="database"></param>
        [Bam.Net.Exclude]
        public static User OneWhere(WhereDelegate<UserColumns> where, IDatabase database = null)
        {
        ...
        /// <param name="database"></param>
        [Bam.Net.Exclude]
        public static UserCollection Top(int count, WhereDelegate<UserColumns> where, IDatabase database = null)
        {
