...
namespace Bam.Net.UserAccounts.Data
{
	...
	public Permission PermissionOfPermissionId
	{
		...
		/// </param>
		[Bam.Net.Exclude]
		public static GroupPermissionCollection Top(int count, WhereDelegate<GroupPermissionColumns> where, OrderBy<GroupPermissionColumns> orderBy, IDatabase database = null)
		{
			GroupPermissionColumns c = new GroupPermissionColumns();
			IQueryFilter filter = where(c);         
			
			IDatabase db = database ?? Db.For<GroupPermission>();
