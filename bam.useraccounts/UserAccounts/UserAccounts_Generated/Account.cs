...
namespace Bam.Net.UserAccounts.Data
{
	...
	public User UserOfUserId
	{
		...
		/// </param>
		public static AccountCollection LoadAll(IDatabase database = null)
		{
			IDatabase db = database ?? Db.For<Account>();
		...
		/// <param name="db"></param>
		[Bam.Net.Exclude]
		public static AccountCollection Where(Func<AccountColumns, QueryFilter<AccountColumns>> where, IOrderBy<AccountColumns> orderBy = null, IDatabase database = null)
		{
		...
		/// <param name="db"></param>
		[Bam.Net.Exclude]
		public static AccountCollection Where(WhereDelegate<AccountColumns> where, IDatabase database = null)
		{		
			database = database ?? Db.For<Account>();
		...
		[Bam.Net.Exclude]
		public static AccountCollection Where(WhereDelegate<AccountColumns> where, IOrderBy<AccountColumns> orderBy = null, IDatabase database = null)
		{		
			database = database ?? Db.For<Account>();
		...
		/// <param name="database"></param>
		public static AccountCollection Where(QiQuery where, IDatabase database = null)
		{
		...
		/// </param>
		[Bam.Net.Exclude]
		public static AccountCollection Top(int count, WhereDelegate<AccountColumns> where, IOrderBy<AccountColumns> orderBy, IDatabase database = null)
		{
			AccountColumns c = new AccountColumns();
			IQueryFilter filter = where(c);         
		...
		[Bam.Net.Exclude]
		public static AccountCollection Top(int count, QueryFilter where, string orderBy = null, SortOrder sortOrder = SortOrder.Ascending, IDatabase database = null)
		{
			IDatabase db = database ?? Db.For<Account>();
			IQuerySet query = GetQuerySet(db);
			query.Top<Account>(count);
		...
		/// Which database to query or null to use the default
		/// </param>
		public static AccountCollection Top(int count, QiQuery where, IDatabase database = null)
		{
			IDatabase db = database ?? Db.For<Account>();
			IQuerySet query = GetQuerySet(db);
			query.Top<Account>(count);
		...
		/// </param>
		[Bam.Net.Exclude]
		public static long Count(WhereDelegate<AccountColumns> where, IDatabase database = null)
		{
			AccountColumns c = new AccountColumns();
			IQueryFilter filter = where(c) ;
		...
		private static Account CreateFromFilter(IQueryFilter filter, IDatabase database = null)
		{
			IDatabase db = database ?? Db.For<Account>();			
			var dao = new Account();
