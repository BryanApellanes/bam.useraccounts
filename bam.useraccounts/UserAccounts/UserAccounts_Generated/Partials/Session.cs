...
namespace Bam.Net.UserAccounts.Data
{
    ...
    public partial class Session: IRequiresHttpContext
    {
        ...
        public static Session Init(IHttpContext context, IDatabase db = null)
        {
        ...
        public static Session Get(IHttpContext context, IDatabase db = null)
        {
        ...
        public static Session Get(IRequest request, IResponse response, IDatabase db = null)
        {
            ...
            get
            {
                ...
                if (state != null)
                {
                    ...
                    else
                    {
                        ...
                        throw new NotImplementedException("Revisit this to determine appropriate implementation for binary data");
                    }
                }
