    ...
    public partial class Password
    {
        ...
        public static string Get(User user)
        {
            ...
            if (password != null)
            {
                ...
                throw new NotImplementedException("Revisit this to correct password storage handling");
            }
        ...
        public static bool Validate(string userName, string password, IDatabase db = null, bool updateFailure = true)
        {
            User user = User.GetByUserName(userName, db);
            return Validate(user, password, db, updateFailure);
        }

        public static bool Validate(User user, string password, IDatabase db = null, bool updateFailure = true)
        {
